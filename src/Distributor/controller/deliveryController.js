...
import { DeliveryMiddleware } from "../middleware/deliveryMiddleware.js";

export class deliveryController {}

deliveryController.Delivery = {
  getDelivery: async (req, res) => {
    DeliveryMiddleware.Delivery.getDelivery(req)
      .then((data) => {
  ...
  addDelivery: async (req, res) => {
    DeliveryMiddleware.Delivery.addDelivery(req)
      .then((data) => {
        const response = ApplicationResult.forCreated();
        var statuscode = 0;
        ApplicationResponse.success(
  ...
  updateDelivery: async (req, res) => {
    DeliveryMiddleware.Delivery.updateDelivery(req)
      .then((data) => {
        const response = ApplicationResult.forCreated();
        var statuscode = 0;
        ApplicationResponse.success(
  ...
  deleteDelivery: async (req, res) => {
    DeliveryMiddleware.Delivery.deleteDelivery(req)
      .then((data) => {
        const response = ApplicationResult.forCreated();
        var statuscode = 0;
        ApplicationResponse.success(
